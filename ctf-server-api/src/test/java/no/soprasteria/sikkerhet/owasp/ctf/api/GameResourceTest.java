...
public class GameResourceTest {
    ...
    public void skal_kunne_starte_et_spill() throws Exception {
        ...
        assertThat(gameResource.list(application).get(0).get("gameOn")).isEqualTo(Boolean.FALSE);
        gameResource.startGame(application);

        assertThat(gameResource.list(application).get(0).get("gameOn")).isEqualTo(Boolean.TRUE);
    }
