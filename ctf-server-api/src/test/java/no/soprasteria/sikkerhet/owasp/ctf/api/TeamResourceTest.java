...
public class TeamResourceTest {
    ...
    public void skal_vise_alle_registrerte_team() {
        resource.add(application, TeamNameParameter.from("0xDEADBEEF"));
        resource.add(application, TeamNameParameter.from("SYS64764"));
        List<Map<TeamResource.TeamResourceResponseKeys, String>> teamListe = resource.list(application);
    ...
    public void skal_slette_baade_team_og_poengsummer() {
        resource.add(application, TeamNameParameter.from("0xDEADBEEF"));
        Response response = resource.del(application, TeamNameParameter.from("0xDEADBEEF"));
